...
import com.DCHZ.TYLINCN.entity.PGongZhangDetailEntity;
 ...
 */
public class GongZhangJIeCHuDetail  extends BaseNormalActivity {
    ...
    private RspGongZhangJieChuDetailEntity rsp;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initExtras();
        initLayout();
        registMsgRecevier(EventCommon.EVENT_GONGZHANGJIECHU_DETAIL);
        ...
        int seq= ProtocalManager.getInstance().getGongZhangJieChuDetail(entity);
        mReqList.add(seq);
        showLoading();
    }
...
//		mMsgPage.setRefreshListener(mRefreshListener);
        if(this.type== Common.TYPE_DAIBAN){
            ...
            mBottomView.setClickListener(new IDaiBanClickListener() {
                ...
                public void typeClickListener() {
                    ...
                    IntentUtils.starTiJiaoActivity(GongZhangJIeCHuDetail.this, GET_TYPE,noTag);
                }
                ...
                public void nextClickListener() {
                    ...
                    if("同意".equals(TJtype)||"退回".equals(TJtype)){
                        IntentUtils.starJieShouRenActivity(GongZhangJIeCHuDetail.this, mList, GET_JIESHOUREN);
                    }else{
                        showToast("请先选择提交方式！");
                    }
                }
    ...
    public void handleReceiveMsg(int eventId, int seqNo, Object obj) {
        // TODO Auto-generated method stub
        if(eventId==EventCommon.EVENT_GONGZHANGJIECHU_DETAIL){
            if(obj instanceof RspGongZhangJieChuDetailEntity){
                RspGongZhangJieChuDetailEntity rsp=(RspGongZhangJieChuDetailEntity) obj;
    ...
    protected void handleMsg(Message msg) {
        ...
        switch (what) {
            case FLAG_SET_TOP:
                rsp=(RspGongZhangJieChuDetailEntity)msg. obj;
                if(rsp!=null&&rsp.isSucc){
//				List<PShenPiInfoEntity> mList=rsp.mEntity.BXMXInfo;
                    ArrayList<PGongZhangEntity> bxInfo=rsp.mEntity.GongZhangJieChuInfo;
                    if(bxInfo!=null&&bxInfo.size()>0)
//				mHeader.setItem(bxInfo.get(0).BXMXZhuDaoBuMen);
                        mHeader.setValue(bxInfo.get(0).GZShenQingRen, bxInfo.get(0).DEName, bxInfo.get(0).GZLingZhangRiQi.split(" ")[0], bxInfo.get(0).GZGuiHuanRiQi.split(" ")[0]);
...
//			showToast(mBLUserID);
    ...
    private View getHeaderView(ArrayList<PGongZhangEntity> bxInfo){
